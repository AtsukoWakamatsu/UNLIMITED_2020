...
<h4>・全体的なこと</h4>　ーーーーーー　　ゆうか（代表）
 
<h4>・HOW TO的なこと</h4>　ーーーー　　こうき、いぶき、あやか、ひなこ
  
<h4>・テクノロジー関連</h4>　ーーーー　　あつこ（副代表）

<h4>・会計</h4>　ーーーーーーーーーー　　ちな（会計）

<h4>スタディツアー関連</h4>　ーーーー　　かいと
